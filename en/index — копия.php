<html lang="ru">
	<head>
		...
		<!-- Заголовок страницы -->
		<title>Voice Bot Simulator for children and teenagers SkyKids</title>
		...
		<script>
			...
			if (getCookie('c_name') != 'Y') {
			}
		</script>


<?php
if ( isset ( $_GET["lang"] ) and in_array ( $_GET["lang"], array ( 'ru', 'de' ) ) )
{
			...
			<div class="main">
							...
							<div class="header__scroll _flex">
								<nav class="header__menu _flex">
									...
									<div class="header__item header__item_marg">
										<a href="/?noredirect" class="header__link">Rus / Eng</a>
									</div>
								</nav>

								<div class="header__contact _flex">
									<div class="header__phone">
										<a href="tel:+74957802002">+7 (499) 719-29-59</a>
									</div>
					...
					<section class="first-section">
						...
						<div class="cont">
							<div class="first-section__box">
								<h1 class="first-section__title">"Voice Bot Simulator for children and teenagers" SkyKids</h1>
											...
											<div class="form-flex _flex">
												<div class="form__line">
													<div class="form__field">
														<input type="text" name="" value="" placeholder="Enter your name" class="form__input name">
													</div>
												</div>
				...
				<section class="main-about _marg" id="anchor1">
					<div class="cont">
						...
						<div class="main-subtitle main-subtitle_white main-subtitle_left animate fadeInUp">"SkyKids imitates possible dialogues with peers, teachers and suggests <br>how to behave in this or that situation and emerge victorious from it"</div>

						<div class="main-about__items _flex">
							<div class="main-about__item animate fadeIn">Bullying <br>reflection</div>
							...
							<div class="main-about__item animate fadeIn">Debate and <br>argumentation of one's point of view</div>
							<div class="main-about__item animate fadeIn">Reading emotions and empathy</div>
							<div class="main-about__item animate fadeIn">Bullying from <br>seniors</div>
							<div class="main-about__item animate fadeIn">Abuse from <br>teachers</div>
							<div class="main-about__item animate fadeIn">Difficulties of socialization and communication in a team</div>
							<div class="main-about__item animate fadeIn">Building long and <br>friendly <br>relationships</div>
						...
						<div class="how-work__items">
							<div class="how-work__flex _flex animate">
								<div class="how-work__item fadeIn">
									...
									<div class="how-work__desc">You choose a problem <br>close to you</div>
								</div>
								<div class="how-work__item fadeIn" data-delay="3">
									...
									<div class="how-work__desc">Choose the <br>most convenient script <br>for you</div>
								</div>
						...
						<div class="tabs-container animate fadeInUp">
							...
							<div class="tab-content level1" id="tab1">
								<div class="video">
									...
									<a href="https://youtu.be/sfd2xj9xtN0" data-fancybox="" class="video__link">
						...
						<div class="cont">
							...
							<div class="subscription-options__items _flex animate">
								<div class="subscription-options__item fadeInUp">
									...
									<div class="subscription-options__price">499 rub.</div>

									<div class="subscription-options__time">Validity: <b>1 Week</b></div>
7
									<button type="button" data-content="#modal_callback" class="modal-btn subscription-options__btn">Subscribeу</button>
								</div>
								<div class="subscription-options__item fadeInUp" data-delay="3">
									...
									<div class="subscription-options__price">1599 rub.</div>
...
7
								...
								<div class="subscription-options__item fadeInUp" data-delay="6">
									...
									<div class="subscription-options__price">7199 rub.</div>

									<div class="subscription-options__time">Validity: <b>1 months</b></div>
7
									<button type="button" data-content="#modal_callback" class="modal-btn subscription-options__btn">Subscribeу</button>
								</div>
							</div>
							...
							<div class="subscription-demo _flex _marg animate">
								...
								<div class="wrap-btn subscription-demo__wrap-btn fadeInDown">
									<a href="/" class="btn-orange">Get access</a>
								</div>
							</div>
						</div>
					</section>
									...
									<form action="" class="form ajax_submit">
										...
										<div class="form__block marg">
											<div class="form-flex _flex">
												<div class="form__line">
													<div class="form__field">
														<input type="text" name="" value="" placeholder="Введите ваше имя" class="form__input name">
													</div>
												</div>
				...
				<section class="main-partner _marg">
					<div class="cont">
						...
						<div class="main-partner__items _flex animate fadeInUp">
							<div class="main-partner__item">
								<img data-src="/images/logo2.svg" src="/images/img_plug.png" alt="" class="lazyload">
							</div>
							<div class="main-partner__item">
								<img data-src="/images/logo2.svg" src="/images/img_plug.png" alt="" class="lazyload">
							</div>
				...
				<div class="cont _flex animate">
					...
					<div class="footer__contact fadeIn">
						<div class="footer__phone">
							<a href="tel:+74997192959">+7 (499) 719-29-59</a>
						</div>
						...
						<div class="footer__login">
							<a href="/" class="login-btn login-btn__footer">
								<span>
									<svg>
										<use xlink:href="#ic_user"></use>
									</svg>
