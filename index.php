<html lang="ru">
	...
	console.log(uri)
			...
			// 		case 'ru': break;
			// 		default: header('Location: /en/index.php'); break;
			// 	}
			// }
		</script>
		...
		<div class="wrap">
			<div class="main">
							...
							<div class="header__scroll _flex">
								<nav class="header__menu _flex">
									<div class="header__item">
										<button class="header__link scroll-btn" data-anchor="#anchor1">О платформе</button>
									</div>
									<div class="header__item">
										<button class="header__link scroll-btn" data-anchor="#anchor2">Как это работает</button>
									</div>
									<div class="header__item">
										<button class="header__link scroll-btn" data-anchor="#anchor3">Демонстрация</button>
									</div>
									<div class="header__item">
										<button class="header__link scroll-btn" data-anchor="#anchor4">Преимущества</button>
									</div>
									<div class="header__item header__item_marg">
										<a href="/en" class="header__link">Rus / Eng</a>
									</div>
								</nav>
					...
					<section class="first-section">
						...
						<div class="cont">
							<div class="first-section__box">
								...
								<div class="first-section__info">SkyKids научит:</div>

								<div class="first-section__list swiper">
									<div class="swiper-wrapper">
										<div class="swiper-slide first-section__li">Справляться с абьюзом</div>
										<div class="swiper-slide first-section__li">Выходить из конфликтных ситуаций</div>
										<div class="swiper-slide first-section__li">Давать отпор обидчикам</div>
							...
							<div class="main-form__flex _flex animate fadeInUp">
								...
								<div class="main-form__colr">
									<form action="" class="form ajax_submit">
										<div class="form__title">Получите демо-доступ <br>к роботу-тренажеру <span>«SkyKids»</span></div>

										<div class="form__block">
											<div class="form-flex _flex">
												<div class="form__line">
													<div class="form__field">
														<input type="text" name="name" value="" placeholder="Введите ваше имя" class="form__input name">
													</div>
												</div>

												<div class="form__line">
													<div class="form__field">
														<input type="tel" name="phone" value="" placeholder="Номер телефона" class="form__input phone">
													</div>
												</div>
											</div>
											...
											<div class="form__bot _flex">
												<div class="form-submit">
													<button type="submit" class="btn-orange big">Получить доступ</button>
												</div>

												<div class="form__agree">Нажимая на кнопку, вы даете согласие на обработку своих <button class="modal-btn" data-content="#modal_policy">персональных данных</button></div>
											</div>
										</div>
									</form>
								</div>
						...
						<div class="cont">
							<div class="main-quote__flex _flex animate">
								<div class="text-block main-quote__text-block fadeInLeft">
									<h2>Все мы хотим, чтобы наши дети были уверены в себе, <span>добивались поставленных целей</span> и могли постоять за себя</h2>

									<p>
										Но как быть, когда ребенок больше доверяет гаджету и плохо социализирован? Заговорить с ним на одном языке!
									</p>

									<p>
										Мы объединили технологию, исследования и педагогику в одном продукте, который позволяет решить множество проблем социализации
									</p>
								</div>
								...
								<div class="main-quote__colr fadeInRight">
									...
									<div class="main-quote__name">Алексей Балакирев</div>

									<div class="main-quote__position">Основатель платформы</div>
								</div>
							</div>
						</div>
					</section>
					...
					<div class="cont">
						<div class="main-info__flex _flex animate">
							...
							<div class="text-block main-info__text-block fadeInRight">
								<h2>Путь ответственного родителя:</h2>

								<ul>
									<li>Увидеть проблему</li>
									<li>Поговорить с ребенком</li>
									<li>Обратиться к психологу</li>
									<li>Проводить с ребенком больше времени</li>
									<li>Применять инструменты социализации</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<section class="main-about _marg" id="anchor1">
					<div class="cont">
						<div class="main-title main-title_white main-title_left animate fadeInUp">Платформа SkyKids поможет ребенку выработать навыки&#160;коммуникации в десятках различных ситуациях</div>

						<div class="main-subtitle main-subtitle_white main-subtitle_left animate fadeInUp">SkyKids имитирует возможные диалоги со сверстниками, учителями и подсказывает как правильно себя вести <br>в той или иной ситуации и выходить из нее победителем</div>

						<div class="main-about__items _flex">
							<div class="main-about__item animate fadeIn">Отражение <br>буллинга</div>
							<div class="main-about__item animate fadeIn">Как общаться с хулиганами и <br>задирами</div>
							<div class="main-about__item animate fadeIn">Развитие эмоционального интеллекта</div>
							<div class="main-about__item animate fadeIn">Дебаты и <br>аргументация своей точки зрения</div>
							<div class="main-about__item animate fadeIn">Чтение эмоции и эмпатия</div>
							<div class="main-about__item animate fadeIn">Буллинг от <br>старших</div>
							<div class="main-about__item animate fadeIn">Абьюз от <br>учителей</div>
							<div class="main-about__item animate fadeIn">Сложности Социализации и общение в коллективе</div>
							<div class="main-about__item animate fadeIn">Построение долгих <br>и дружеских <br>отношений</div>
							<div class="main-about__item animate fadeIn">Общение с противоположным полом</div>
						...
						<div class="about-quote _flex animate">
							<div class="about-quote__coll">
								<div class="about-quote__important fadeInUp">При разработке диалогов были учтены более 300 российских и зарубежных социальных исследований и разобраны тысячи конкретных случаев с которыми родители и дети обращались к психологам</div>

								<div class="about-quote__block fadeInUp" data-delay="3">
									<div class="text-block text-block_white">
										<h4>«Проработка стрессовых сценариев — верный путь к развитию уверенности, силы воли и характера у ребенка и помощь в избежании психологических травм в дальнейшем»</h4>
									</div>
								</div>
							</div>
							...
							<div class="about-quote__colr fadeInRight" data-delay="2">
								...
								<div class="about-quote__box">
									<div class="about-quote__name">Иванова Галина</div>

									<div class="about-quote__position">психолог</div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="how-work__items">
							<div class="how-work__flex _flex animate">
								<div class="how-work__item fadeIn">
									...
									<div class="how-work__name">Выбор проблемы</div>

									<div class="how-work__desc">Вы выбираете проблему, <br>близкую вам</div>
								</div>
								<div class="how-work__item fadeIn" data-delay="3">
									...
									<div class="how-work__name">Выбор сценария</div>

									<div class="how-work__desc">Выбираете наиболее <br>удобный для вас <br>сценарий</div>
								</div>
								<div class="how-work__item fadeIn" data-delay="5">
									...
									<div class="how-work__name">Диалог</div>

									<div class="how-work__desc">Ребенок проводит <br>диалоги с роботом, <br>получая рекомендации от <br>психолога</div>
								</div>
								<div class="how-work__item fadeIn" data-delay="7">
									...
									<div class="how-work__name">Отчет</div>

									<div class="how-work__desc">После прохождения тренировки вы получаете отчет в виде сохраненного текстового и аудио диалога, на основании которого вы можете принять решение о продлении занятий, изменениях в программе или удачном завершении социализации ребенка</div>
								</div>
				...
				<section class="training _marg" id="anchor3">
					<div class="cont">
						<div class="main-title main-title_white animate fadeInUp">Посмотрите как проходят тренировки</div>
				...
				<section class="advantages _marg" id="anchor4">
					<div class="cont">
						<div class="main-title animate fadeInUp">Преимущества тренажера</div>
						...
						<div class="advantages__items">
							<div class="advantages__flex _flex animate">
								<div class="advantages__item fadeInUp">
									...
									<div class="advantages__name">Робота нельзя отличить от человека (эмоции, голос, поведение)</div>

									<div class="advantages__desc">Поэтому тренировки не надоедают ребенку</div>
								</div>
								<div class="advantages__item fadeInUp" data-delay="2">
									...
									<div class="advantages__name">Удобно пользоваться на любом устройстве</div>

									<div class="advantages__desc">Платформа доступна на web-версии и мобильных приложениях IOS и Android</div>
								</div>
								<div class="advantages__item fadeInUp" data-delay="4">
									...
									<div class="advantages__name">Конфликтные ситуации, похожие на реальные</div>

									<div class="advantages__desc">В тренажер интегрированы диалоги, с которыми сталкиваются дети</div>
								</div>
								<div class="advantages__item fadeInUp" data-delay="6">
									...
									<div class="advantages__name">Платформа работает как опытный наставник</div>

									<div class="advantages__desc">Анализирует тренировки и дает рекомендации по повышению качества переговоров</div>
								</div>
								<div class="advantages__item fadeInUp" data-delay="8">
									...
									<div class="advantages__name">Каталог более чем из 200 сценариев</div>

									<div class="advantages__desc">Вы можете выбрать сценарии, которые точечно решают вашу проблему</div>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="section-gray section-gray_pad _marg">
					<section class="subscription-options">
						<div class="cont">
							<div class="main-title animate fadeInUp">Варианты подписки на тренажер</div>

							<div class="subscription-options__items _flex animate">
								<div class="subscription-options__item fadeInUp">
									<div class="subscription-options__name">Микро</div>

									<div class="subscription-options__desc">Подойдет для тестирования платформы</div>

									<div class="subscription-options__price">499 руб.</div>

									<div class="subscription-options__time">Срок действия: <b>1 неделя</b></div>

									<button type="button" data-content="#modal_callback" class="modal-btn subscription-options__btn">Оформить подписку</button>
								</div>
								<div class="subscription-options__item fadeInUp" data-delay="3">
									<div class="subscription-options__name">Стандартный</div>

									<div class="subscription-options__desc">Для проработки одной или нескольких ситуаций</div>

									<div class="subscription-options__price">1599 руб.</div>

									<div class="subscription-options__time">Срок действия: <b>1 месяц</b></div>

									<button type="button" data-content="#modal_callback" class="modal-btn subscription-options__btn">Оформить подписку</button>
								</div>
								<div class="subscription-options__item fadeInUp" data-delay="6">
									<div class="subscription-options__name">Оптимальный</div>

									<div class="subscription-options__desc">Для регулярных занятий и поддержания навыков</div>

									<div class="subscription-options__price">7199 руб.</div>

									<div class="subscription-options__time">Срок действия: <b>6 месяцев</b></div>
							...
							<div class="subscription-demo _flex _marg animate">
								<div class="subscription-demo__box fadeInDown">
									<div class="subscription-demo__title">Получить демо-доступ к роботу-тренажеру «SkyKids»</div>

									<div class="subscription-demo__desc">Срок действия пробного периода: <b>1 час</b></div>
								</div>

								<div class="wrap-btn subscription-demo__wrap-btn fadeInDown">
									<button type="button" data-content="#modal_callback" class="modal-btn btn-orange">Получить доступ</button>
								</div>
							</div>
						</div>
					</section>
						...
						<div class="cont">
							<div class="free-consultation__bg animate _flex">
								...
								<div class="free-consultation__colr fadeInRight">
									<form action="" class="form ajax_submit">
										<div class="form__title">Запишитесь на бесплатную демонстрацию платформы <span>«SkyKids»</span></div>

										<ul class="form__list">
											<li>Покажем интерфейс и функционал тренажера</li>
											<li>Продемонстрируем различные сценарии</li>
											<li>Ответим на интересующие вопросы</li>
										</ul>
				...
				<section class="main-partner _marg">
					<div class="cont">
						<div class="main-title animate fadeInUp">Наши проекты</div>
			...
			<footer class="footer _marg">
				<div class="cont _flex animate">
					<div class="footer__coll fadeIn">
						...
						<div class="footer__copy">&copy; 2018-2022. ООО ”СКАЙТРЭЙНЕР”.</div>
					...
					<nav class="footer__menu fadeIn">
						<div class="footer__item">
							<button class="footer__link scroll-btn" data-anchor="#anchor1">О платформе</button>
						</div>
						<div class="footer__item">
							<button class="footer__link scroll-btn" data-anchor="#anchor2">Как это работает</button>
						</div>
						<div class="footer__item">
							<button class="footer__link scroll-btn" data-anchor="#anchor3">Демонстрация</button>
						</div>
						<div class="footer__item">
							<button class="footer__link scroll-btn" data-anchor="#anchor4">Преимущества</button>
						</div>
						<div class="footer__item">
							<button class="footer__link scroll-btn" data-anchor="#anchor5">Контакты</button>
						</div>
					</nav>
		...
		<section class="modal" id="modal_callback">
			...
			<div class="modal__data">
				<form action="" class="form ajax_submit">
					...
					<div class="form-submit">
						<button type="submit" class="btn-orange big">Отправить</button>
					</div>
